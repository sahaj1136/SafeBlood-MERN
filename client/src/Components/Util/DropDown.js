...
const DropDown = (props) => {
    ...
    const s2 =
    "px-4 py-2 font-semibold text-base rounded-xl group-hover:px-12 group-hover:drop-shadow-2xl shadow-sm bg-blood z-30 text-white-900 hover:drop-shadow-md hover:opacity-80";

    return (
    <div className="group inline-block relative">
    <button
      className="text-gray-700 font-semibold rounded inline-flex"
    >
      <span className={s2}>
